...
function Home() {
  return (
    <div className="bg-gradient-to-b from-black via-home to-black">
      <NavBar />
      <div className="flex gap-8 pt-8 pb-8 flex-col w-full items-center">
        ...
        <Link
          to="/home/formulaE"
          className="overflow-hidden flex flex-col gap-4 md:p-8 items-center"
        >
          <h2 className="text-2xl font-bold">ForumlaE</h2>
          <p className="w-[50%] md:flex hidden">
          ...
          <p className="md:hidden flex text-center w-3/4">
            Um esporte emocionante que incentivar o desenvolvimento de
            tecnologias sustentáveis e renováveis.
          </p>
          ...
          <img
            ...
            alt="Formula E"
            className="transform transition-transform duration-300 w-10/12 hover:scale-105 md:max-w-[50%] rounded-3xl"
          />
        </Link>
        <Link
          to="/home/Escalada"
          className="overflow-hidden flex flex-col gap-4 md:p-8 items-center"
        >
          <h2 className="text-2xl font-bold">Escalada</h2>
          <p className="w-[50%] md:flex hidden">
          ...
          <p className="md:hidden flex text-center w-3/4">
            Além de desafiar limites físicos e mentais, a modalidade busca
            incentivar práticas sustentáveis e saudaveis.
          </p>
          <img
